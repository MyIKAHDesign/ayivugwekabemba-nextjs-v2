    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      <section className="mb-12 flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-2/3 md:pl-8">
          ...
          <p className="text-base text-gray-600 mb-4">I am a Google-certified Project Manager and Software Developer, passionate about creating innovative solutions. As a dedicated advocate for the Kifuliiru language, I strive to empower communities through technology and cultural preservation.</p>
        </div>
      </section>
