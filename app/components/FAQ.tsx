          ...
          {faqs.map((faq, index) => (
            ...
            >
              ...
              <div
                ...
                ${
                  darkMode
                    ? "bg-gradient-to-t from-slate-800/90 via-slate-700/80 to-slate-600/90"
                    : "bg-gradient-to-t from-slate-200/80 via-slate-100/70 to-slate-50/60"
                }`}
              />
              ...
              >
                <div className="flex items-center justify-between">
                  <h3
                    className={`font-jetbrains-mono text-xl font-medium pr-8 transition-colors duration-500
                    ${darkMode ? "text-slate-100" : "text-slate-900"}
                    ${
                      darkMode
              ...
              >
                <p
                  className={`p-6 pt-0 font-space-grotesk text-lg leading-relaxed transition-colors duration-500
                  ${darkMode ? "text-slate-300" : "text-slate-600"}
                  ${
                    darkMode
