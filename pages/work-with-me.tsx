        ...
        <div className="relative px-1 lg:px-1">
          ...
          <div className="mx-auto max-w-2xl py-16 sm:py-30 lg:py-30">
            ...
            <div className="text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Would you like to join me in this journey about creating more
                content in the Kifuliiru language? This place is here for that.
                Know more to find more on how you may help me and also help the
                KIfuliiru language.
              </p>
